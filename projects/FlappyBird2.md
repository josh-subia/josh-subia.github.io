...
<img align="left" height="510" class="img-fluid" src="../img/flappy-bird/NoPipes.png"> 
...
<br/><br/><img align="left" height="400" class="img-fluid" src="../img/flappy-bird/difficulties.png"> <img align="left" height="400" class="img-fluid" src="../img/flappy-bird/WithPipes.png">The game also implements multiple difficulties, where the space between the pipes would continually get smaller as the difficulty increases. This game was rather challenging to create because I had to do it alone, but with time and perseverance, I accomplished what I initially wanted to, with many more features hopefully to come in the future. 