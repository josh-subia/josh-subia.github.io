...
<img align="left" height="300" class="img-fluid" src="../img/flappy-bird/WithPipes.png"> Flappy Bird 2 is an endlass game I developed using C# in Unity. It includes multiple difficulty levels: easy, medium, hard, and infuriating, along with a life system. In the future I hope to implement many more features into the game.
